...
agents: []
handoffs:
  - label: Implementar base de k6
    agent: QA Performance Engineer
    prompt: Usa la spec generada en .github/specs/ para implementar assets de k6.
    send: false
  - label: Implementar script de k6
    agent: QA Performance Engineer
    prompt: Usa la spec generada en .github/specs/ para implementar el script de performance.
    send: false
---
...
2. **Lee el tech stack:** `.github/instructions/k6.instructions.md`
3. **Lee la arquitectura:** `.github/instructions/k6.instructions.md`
